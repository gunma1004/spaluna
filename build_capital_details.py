...
DETAILED_REGIONS = {
    ...
    "incheon_namdong": ("인천 남동구", ["guwol", "ganseok", "mansu", "nonhyeon", "seochang", "dorim"]),
    ...
    "seongnam_jungwon": ("성남 중원구", ["moran", "seongnam", "sangdaewon", "hagdaewon", "geumgwang", "bank"]),
            ...
            <div class="vendor-body">
                <div class="vendor-header">
                    <div>
                        ...
                        <span class="vendor-title">프리미엄 힐링 홈케어</span>
                    </div>
...
for folder, (kr_name, sub_dongs) in DETAILED_REGIONS.items():
    ...
    with open(index_path, "w", encoding="utf-8") as f:
        f.write(HTML_TEMPLATE.format(
            ...
            desc=f"{kr_name} 전 지역 24시 출장 마사지 및 홈타이 추천.",
...
print(f"🎉 경기/인천 세부 구·동 분할 완료! 총 {count}개의 세부 지역 HTML 파일이 생성되었습니다.")